...
var css = "/* add css styles here (optional) */\nbody{\n  background-color:ghostwhite;\n}\n.styles_inputBox__1yBpl{\n  font-size: 12px;\n  padding: 10px 20px;\n  height:20px;\n  border:1px solid rgba(0, 0, 0, 0.205);\n  border-radius: 5px;\n  color:#000;\n}\n.styles_inputBox__1yBpl:focus{\noutline: none;\nborder-color: blue;\n}\n.styles_dropdown__2xflg{\n  background-color: #fff;\n  box-shadow: rgba(0, 0, 0, 0.1) 0 0 0 0, rgba(0, 0, 0, 0.1) 0px 4px 11px;\n  border-radius: 5px;\n}\n.styles_dropdownList__XJkBC{\n  list-style-type: none;\n  margin: 0;\n  padding: 0;\n}\n.styles_dropdownListItem__2NcVD{\n  padding: 10px 20px;\n  background-color: #fff;\n  border: 1px solid rgba(0, 0, 0, 0.205);\n  height: 40px;\n  display: flex;\n  align-items: center;\n}\n.styles_dropdownListItem__2NcVD:hover{\nbackground-color:rgba(218, 214, 214, 0.699);\ncursor: pointer;\n\n}\n\n.styles_dropdownListItem__2NcVD:first-child{\n  border-top-left-radius: 5px;\n  border-top-right-radius: 5px;\n}\n.styles_dropdownListItem__2NcVD:last-child{\n  border-bottom-left-radius: 5px;\n  border-bottom-right-radius: 5px;\n}\n.styles_dropdownListItem__2NcVD:not(:first-child) {\n  border-top: 0;\n}\n.styles_searchBoxContainer__3MklX{\n display: flex;\n flex-direction: column;\n margin: 10%;\n}";
var styles = { "inputBox": "styles_inputBox__1yBpl", "dropdown": "styles_dropdown__2xflg", "dropdownList": "styles_dropdownList__XJkBC", "dropdownListItem": "styles_dropdownListItem__2NcVD", "searchBoxContainer": "styles_searchBoxContainer__3MklX" };
styleInject(css);
...
var ReactSearchBox = function (_Component) {
  inherits(ReactSearchBox, _Component);

  function ReactSearchBox(props) {
    classCallCheck(this, ReactSearchBox);

    var _this = possibleConstructorReturn(this, (ReactSearchBox.__proto__ || Object.getPrototypeOf(ReactSearchBox)).call(this, props));
    ...
    _this.handleDropdownItemClick = function (record) {
      /**
            ...
            return React__default.createElement(
              'li',
              {
                ...
                onClick: function onClick() {
                  return _this.handleDropdownItemClick(record);
                }
              },
              record.value
            );
    ...
    _this.fuse = new Fuse(data, options);
    return _this;
  }

  createClass(ReactSearchBox, [{
    ...
    value: function componentDidMount() {
      ...
      var matchedRecords = this.fuse.search(value);
      this.setState({
        value: value.trim(),
        matchedRecords: matchedRecords,
        /**
